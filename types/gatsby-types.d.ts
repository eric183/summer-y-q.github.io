...
type SiteSiteMetadataResumeInfoFilterInput = {
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly years: Maybe<StringQueryOperatorInput>;
  readonly desc: Maybe<StringQueryOperatorInput>;
...
type SiteSiteMetadataResumeInfoSocialFilterListInput = {
  readonly elemMatch: Maybe<SiteSiteMetadataResumeInfoSocialFilterInput>;
};

type SiteSiteMetadataResumeInfoSocialFilterInput = {
  readonly text: Maybe<StringQueryOperatorInput>;
  readonly link: Maybe<StringQueryOperatorInput>;
  readonly icon: Maybe<StringQueryOperatorInput>;
};

type SiteSiteMetadataResumeInfoExperienceFilterListInput = {
  readonly elemMatch: Maybe<SiteSiteMetadataResumeInfoExperienceFilterInput>;
};
...
type SiteSiteMetadataResumeInfoExperienceChildrenFilterListInput = {
  readonly elemMatch: Maybe<SiteSiteMetadataResumeInfoExperienceChildrenFilterInput>;
};

type SiteSiteMetadataResumeInfoExperienceChildrenFilterInput = {
  readonly name: Maybe<StringQueryOperatorInput>;
...
type SiteSiteMetadataResumeInfoSkillFilterListInput = {
  readonly elemMatch: Maybe<SiteSiteMetadataResumeInfoSkillFilterInput>;
};

type SiteSiteMetadataResumeInfoSkillFilterInput = {
  readonly name: Maybe<StringQueryOperatorInput>;
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.about'
  | 'siteMetadata.author'
  | 'siteMetadata.fontFamily'
  | 'siteMetadata.desc'
  | 'siteMetadata.resumeInfo.name'
  | 'siteMetadata.resumeInfo.title'
  | 'siteMetadata.resumeInfo.years'
  | 'siteMetadata.resumeInfo.desc'
  | 'siteMetadata.resumeInfo.social'
  | 'siteMetadata.resumeInfo.social.text'
  | 'siteMetadata.resumeInfo.social.link'
  | 'siteMetadata.resumeInfo.social.icon'
...
type SitePageFieldsEnum =
  ...
  | 'pluginCreator.pluginOptions.omitGoogleFont'
...
type fWorkspaceeric183GithubIosrcpagesaboutJs4122199845QueryVariables = Exact<{ [key: string]: never; }>;


type fWorkspaceeric183GithubIosrcpagesaboutJs4122199845Query = { readonly site: Maybe<(
    Pick<Site, 'buildTime'>
    & { readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'about' | 'title'>> }
  )> };

type fWorkspaceeric183GithubIosrcpagesarticleJs2422230711QueryVariables = Exact<{ [key: string]: never; }>;


type fWorkspaceeric183GithubIosrcpagesarticleJs2422230711Query = { readonly allMarkdownRemark: (
    Pick<MarkdownRemarkConnection, 'totalCount'>
    & { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'id' | 'timeToRead' | 'html' | 'excerpt'>
        & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title'>>, readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>> }
      ) }> }
  ), readonly site: Maybe<(
    Pick<Site, 'id'>
...
type fWorkspaceeric183GithubIosrcpagesfileSystemJs792273157QueryVariables = Exact<{ [key: string]: never; }>;


type fWorkspaceeric183GithubIosrcpagesfileSystemJs792273157Query = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: Pick<File, 'relativePath' | 'prettySize' | 'extension' | 'birthTime'> }> } };
...
type fWorkspaceeric183GithubIosrcpagessampleTsx1081387504QueryVariables = Exact<{ [key: string]: never; }>;


type fWorkspaceeric183GithubIosrcpagessampleTsx1081387504Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'about' | 'author' | 'desc' | 'description' | 'fontFamily' | 'title'>
      & { readonly resumeInfo: Maybe<(
        Pick<SiteSiteMetadataResumeInfo, 'desc' | 'name' | 'title' | 'years'>
        & { readonly experience: Maybe<ReadonlyArray<Maybe<(
          Pick<SiteSiteMetadataResumeInfoExperience, 'addr' | 'company' | 'from' | 'title' | 'to'>
          & { readonly children: Maybe<ReadonlyArray<Maybe<Pick<SiteSiteMetadataResumeInfoExperienceChildren, 'desc' | 'isPrivate' | 'role' | 'name' | 'withSkills'>>>> }
        )>>>, readonly skill: Maybe<ReadonlyArray<Maybe<Pick<SiteSiteMetadataResumeInfoSkill, 'children' | 'label' | 'name'>>>>, readonly social: Maybe<ReadonlyArray<Maybe<Pick<SiteSiteMetadataResumeInfoSocial, 'icon' | 'link' | 'text'>>>> }
      )> }
    )> }> };
