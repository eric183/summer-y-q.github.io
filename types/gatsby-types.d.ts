...
type ArticleTypeQueryVariables = Exact<{ [key: string]: never; }>;


type ArticleTypeQuery = { readonly allMarkdownRemark: (
...
type Unnamed_3_Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'author' | 'fontFamily'>> }> };
