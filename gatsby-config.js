    ...
    siteMetadata: {
        ...
        resumeInfo: {
            ...
            desc: [
                ...
                "Nice to meet you, briefly introduce myself. I'm a programmer who changed career, majoring in English in college, I left campus in 2011 after going to the US for an internship, and after returning home, I'm ready to change career by self-learning, I started to engage in front-end and visualization technology and beauty research and development in 2015 for almost six years now, I've done business projects in live streaming, clothing design trend, GIS, e-commerce and other industries, I have rich experience in internet product development, I'm good at BC client development for all platforms. He has led the front-end team, and has experience in developing BI, GIS, CMS, SaaS and DevOps systems, and he knows a little bit about design and 3D art, and has a strong interest in cross terminal development and a little research."
            ],
            social: [
                    ...
                    children: [
                        {
                            ...
                            isPrivate: true,
                            desc: [
                                "我接手项目后，与技术主管一起对业务结构进行梳理，开始着手将对项目进行SaaS化重构，重新设计了脚手架配置，以npm scripts驱动项目参数构建，差异化meta数据并拆分成json配置文件，合并业务结构entry, 最终多个CMS项目合并为一个配置化高复用的前端组件项目;[\b]参与整合devOps，编写dockerFile，语义化构建版本，梳理前端代码规范，替换原本的Javascript，改为Typescript，由webpack ts-loader编译输出生产，最终降低了code review的成本，提高了整体的前端代码质量，运维成本与生产环节的稳定性得到质的提升",
                                "After I took over the project, I worked with the technical director to sort out the business structure and started to refactor the project into SaaS, redesigned the scaffolding configuration, drove the project parameter building with npm scripts, differentiated the meta data and split into json configuration files, merged the business structure entry, and finally merged multiple CMS projects into a configurable and highly reusable front-end component project; [\b] participate in the integration of devOps, write dockerFile, semantic build version, comb front-end code specification, replace the original Javascript, changed to Typescript, compiled by webpack ts-loader output production, and finally reduce the cost of code review, improve the overall front-end The code quality, the cost of operation and maintenance, and the stability of the production link were qualitatively improved."
                            ],
                            link: null
                        },
                        {
